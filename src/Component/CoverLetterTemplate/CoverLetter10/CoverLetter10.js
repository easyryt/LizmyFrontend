...
import styles from "./CoverLetter10.module.css";
...
const CoverLetter10 = () => {
  ...
  const getHTML = () => {
    ...
    <div class="line" style="background-color:${color2}; ">
    <span class="inner_line"  style="border: 6px ${color2} solid ;"><span>
    </div>
...
<div className={styles.line} style={{backgroundColor:color2}}>
  <span className={styles.inner_line } style={{border: `6px ${color2} solid`}}></span>
</div>
