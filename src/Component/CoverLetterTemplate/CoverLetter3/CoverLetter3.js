...
import styles from "./CoverLetter3.module.css";
...
const CoverLetter3 = () => {
  ...
  const getHTML = () => {
    ...
    <div className={styles.content-container}>
      ...
      <div>
  <p>
    <strong style="color: ${color3}; font-family: ${fontStyle}; font-size:${fontSize}px;"> 
       ${formData.nameAndContact.firstName}
        ${formData.nameAndContact.lastName}
    </strong>
   </p>
  <p>  ${formData.nameAndContact.state}</p>
  <p>  ${formData.nameAndContact.city}, ${formData.nameAndContact.zip}</p>
  <p>${formData.nameAndContact.email}</p>
  <p> ${formData.nameAndContact.phoneNumber}</p>
  <p><strong>${formatDate(formData.date)}</strong></p>

  <br/>

  <p><strong>${formData.recipient.firstName} ${formData.recipient.lastName}</strong></p>
  <p>${formData.recipient.companyName}</p>
  <p>${formData.recipient.state}</p>
  <p> ${formData.recipient.city}, ${formData.recipient.zip}</p>
</div>
...
<div class="letter-content">
  <p>Dear <strong>${formData.recipient.firstName} ${formData.recipient.lastName},</strong></p>
  ...
  return (
    <>
      ...
      <div className={styles.content_container}>
        ...
        <div>
    <p>
      <strong style={{ color: color3, fontFamily: fontStyle ,fontSize: fontSize}}> 
         {formData.nameAndContact.firstName}
          {formData.nameAndContact.lastName}
      </strong>
     </p>
 ...
 <br/>
  ...
  <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
    <p><strong>{formData.greeting},</strong></p>
