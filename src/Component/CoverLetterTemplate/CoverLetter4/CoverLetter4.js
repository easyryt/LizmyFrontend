...
import styles from "./CoverLetter4.module.css";
...
const CoverLetter4 = () => {
  ...
  const getHTML = () => {
    ...
    <div class="secondary-text">
     <p> ${formData.nameAndContact.state}, ${formData.nameAndContact.city}, ${formData.nameAndContact.zip} CA</p> | 
...
<div className={styles.main}>
      <div className={styles.header_container} style={{ backgroundColor: color, color: color3 }}>
        ...
        <div className={styles.secondary_text}>
          <p> {formData.nameAndContact.state},  {formData.nameAndContact.city},{formData.nameAndContact.zip}</p> |<p>{formData.nameAndContact.phoneNumber}</p> |
          <p>{formData.nameAndContact.email}</p>
        </div>
      </div>
