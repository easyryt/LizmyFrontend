...
const CoverLetter9 = () => {
  ...
  const getHTML = () => {
    ...
    <div class="heading">
      ...
      formData.nameAndContact.profession
    }</p>
        </div>
     
    </div>
<div class="contact_box" style="background-color:${color}; color:${color2};">
<p>  ${formData.nameAndContact.email}</p> 
<p> ${formData.nameAndContact.state}, ${formData.nameAndContact.city}, ${
  ...
  return (
    <>
      <div className={styles.download_btn}>
        <p className={styles.grid_icon} onClick={handleDownloadClick}>
        ...
        <div>
          <p className={styles.grid_icon} onClick={openModal}>
            <GridOnIcon />
          </p>
      ...
      <div className={styles.main}>
        ...
        <br/>
        <div className={styles.contact_box} style={{backgroundColor:color,color:color2}}>
          <p> {formData.nameAndContact.email}</p>
          <p> {formData.nameAndContact.phoneNumber}</p>
          <p>
